/* Generated automatically by the program 'Release\genpreds.exe'
   from the machine description file 'Q:/Kitware/gccxml/GCC/gcc/config/i386/i386.md'.  */
...
#line 24 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 29 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(FP_REGNO_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (!(
#line 34 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(ANY_FP_REGNO_P (REGNO (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (!(
#line 39 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(FP_REGNO_P (REGNO (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 44 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
#line 49 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 58 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 67 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
{
  return ((GET_CODE (op) == REG) && (
#line 81 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(REGNO (op) == 0))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 86 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(REGNO (op) == FLAGS_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 91 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (!TARGET_64BIT)
...
#line 218 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_DOUBLE:
...
{
  return (
#line 303 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (
#line 311 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (
#line 319 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (
#line 326 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
#line 336 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (!flag_pic)
    return 0;
...
{
  return (
#line 356 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(!TARGET_64BIT || !flag_pic)) ? (nonmemory_operand (op, mode)) : ((register_operand (op, mode)) || ((const_double_operand (op, mode)) && (
#line 360 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(GET_MODE_SIZE (mode) <= 8))));
}

static inline int
symbolic_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 366 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case SYMBOL_REF:
...
#line 409 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  op = XEXP (op, 0);
  if (TARGET_64BIT)
    {
...
#line 438 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 471 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && (
#line 475 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
#line 480 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(XINT (op, 1) == UNSPEC_TP))) && (
(mode == VOIDmode || GET_MODE (op) == mode)));
}
...
#line 491 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 504 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 539 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
#line 548 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(op == const1_rtx));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 553 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(INTVAL (op) == 8));
}

static inline int
const248_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 558 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 566 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 571 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 576 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 581 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 586 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 591 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(INTVAL (op) >= 0 && INTVAL (op) <= 255));
}

static inline int
const_0_to_255_mul_8_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 596 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 605 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 610 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 615 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(INTVAL (op) >= 4 && INTVAL (op) <= 7));
}

static inline int
const_pow2_1_to_8_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 620 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 628 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  unsigned int log = exact_log2 (INTVAL (op));
  return log <= 7;
}
...
#line 636 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 648 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (
#line 652 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (
#line 657 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
#line 665 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  unsigned n_elts;
...
#line 687 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 714 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 731 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 743 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 799 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 811 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
{
  return (memory_operand (op, mode)) && (
#line 828 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(memory_address_length (op) != 0));
}

static inline int
fcmov_comparison_operator_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 833 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 875 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 910 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 967 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
#line 982 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
(INTVAL (XEXP (XEXP (op, 0), 1)) == 8)) && (
#line 983 "Q:/Kitware/gccxml/GCC/gcc/config/i386/predicates.md"
...
insn_const_int_ok_for_constraint (HOST_WIDE_INT ival, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_I:
      return 
#line 93 "Q:/Kitware/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= 0 && ival <= 31);

    case CONSTRAINT_J:
      return 
#line 98 "Q:/Kitware/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= 0 && ival <= 63);

    case CONSTRAINT_K:
      return 
#line 103 "Q:/Kitware/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= -128 && ival <= 127);

    case CONSTRAINT_L:
      return 
#line 108 "Q:/Kitware/gccxml/GCC/gcc/config/i386/constraints.md"
(ival == 0xFF || ival == 0xFFFF);

    case CONSTRAINT_M:
      return 
#line 113 "Q:/Kitware/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= 0 && ival <= 3);

    case CONSTRAINT_N:
      return 
#line 119 "Q:/Kitware/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= 0 && ival <= 255);

    case CONSTRAINT_O:
      return 
#line 124 "Q:/Kitware/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= 0 && ival <= 127);
