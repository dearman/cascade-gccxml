  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      if ((*x).call_site_data != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).call_site_data_used); i0++) {
          gt_ggc_m_7rtx_def ((*x).call_site_data[i0].landing_pad);
        }
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9eh_status, gt_ggc_e_9eh_status))
    {
      ...
      if ((*x).call_site_data != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).call_site_data_used); i0++) {
          gt_pch_n_7rtx_def ((*x).call_site_data[i0].landing_pad);
        }
        gt_pch_note_object ((*x).call_site_data, x, gt_pch_p_9eh_status, gt_types_enum_last);
      }
  ...
  if ((*x).call_site_data != NULL) {
    ...
    for (i0 = 0; i0 != (size_t)(((*x)).call_site_data_used); i0++) {
      if ((void *)((*x).call_site_data) == this_obj)
        op (&((*x).call_site_data[i0].landing_pad), cookie);
    }
    if ((void *)(x) == this_obj)
