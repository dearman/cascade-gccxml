...
/* Set by -mnop-fun-dllimport.
   Ignore dllimport for functions  */
int TARGET_NOP_FUN_DLLIMPORT;
...
static int VAR_m386;
static int VAR_m486;
static int VAR_mconsole;
static int VAR_mcygwin;
static int VAR_mdll;
static int VAR_mintel_syntax;
static int VAR_mpentium;
static int VAR_mpentiumpro;
static int VAR_mthreads;
static int VAR_mwin32;
static int VAR_mwindows;
...
const struct cl_option cl_options[] =
{
  ...
  { "-mconsole",
    ...
    &VAR_mconsole, CLVC_BOOLEAN, 0 },
  { "-mcygwin",
    "Use the Cygwin interface",
    N_OPTS, 7, 475,
    CL_TARGET,
    &VAR_mcygwin, CLVC_BOOLEAN, 0 },
  { "-mdebug-addr",
    0,
    N_OPTS, 11, -1,
    CL_TARGET | CL_REJECT_NEGATIVE | CL_UNDOCUMENTED,
  ...
  { "-mnop-fun-dllimport",
    ...
    N_OPTS, 18, 493,
    CL_TARGET | CL_REPORT,
    &TARGET_NOP_FUN_DLLIMPORT, CLVC_BOOLEAN, 0 },
  ...
  { "-mwin32",
    ...
    N_OPTS, 6, 514,
    CL_TARGET,
    &VAR_mwin32, CLVC_BOOLEAN, 0 },
  { "-mwindows",
    "Create GUI application",
    N_OPTS, 8, 515,
    CL_TARGET,
    &VAR_mwindows, CLVC_BOOLEAN, 0 },
  { "-nostdinc",
